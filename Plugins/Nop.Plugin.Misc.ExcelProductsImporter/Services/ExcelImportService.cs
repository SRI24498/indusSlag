    ...
    public class ExcelImportService : IExcelImportService
    {
        ...
        public async Task<ImportResultModel> ImportAsync(IFormFile file)
        {
            ...
            foreach (var row in records)
            {
                ...
                // --- Specification Attributes (Key=Value;...) ---
                ...
                //    {
                //        var sa = await EnsureSpecificationAttributeAsync(key);
                //        var sao = await EnsureSpecificationAttributeOptionAsync(sa.Id, value);

                //        var mapping = new ProductSpecificationAttributeMapping
                //        {
                //            ProductId = product.Id,
